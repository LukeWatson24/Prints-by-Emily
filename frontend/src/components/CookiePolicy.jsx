...
const CookiePolicy = () => {
  return (
    <div className="checkout-div">
      <h1>Cookie Policy for Prints by Emily</h1>

      <p>
        This is the Cookie Policy for Prints by Emily, accessible from
        www.printsbyemily.com
      </p>
      ...
      <ul>
        <li>By visiting this link: www.printsbyemily.com/policy/cookies</li>
      </ul>
    </div>
  );
};
